...
src_W = np.load("data/%s_%d.npy" % (params.src_lang, params.n_init_ex)).T # 300, 5000 english
tgt_W = np.load("data/%s_%d.npy" % (params.tgt_lang, params.n_init_ex)).T # 300, 5000 es

data = np.zeros((params.n_icp_runs, 2)) #100, 2
